...
export const socialIconEntries: SocialIconEntry[] = [
  {
    id: 'linkedin',
    labelKey: 'social.linkedin',
    href: 'https://linkedin.com/company/jobify',
    icon: LinkedInIcon,
  },
  {
    id: 'github',
    labelKey: 'social.github',
    href: 'https://github.com/jobify',
    icon: GitHubIcon,
  },
  {
    id: 'twitter',
    labelKey: 'social.twitter',
    href: 'https://x.com/jobify',
    icon: X,
  },
  {
    id: 'email',
    labelKey: 'social.email',
    href: 'mailto:hello@jobify.com',
    icon: Mail,
  },
]
