...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <ChevronDownIcon data-slot="accordion-trigger-icon" className={`pointer-events-none shrink-0 group-aria-expanded/accordion-trigger:hidden ${locale === 'ar' ? 'ml-0! mr-auto' : 'ml-auto! mr-0!'}`} />
        <ChevronUpIcon data-slot="accordion-trigger-icon" className={`pointer-events-none hidden shrink-0 group-aria-expanded/accordion-trigger:inline ${locale === 'ar' ? 'ml-0! mr-auto' : 'ml-auto! mr-0!'}`} />
      </AccordionPrimitive.Trigger>
