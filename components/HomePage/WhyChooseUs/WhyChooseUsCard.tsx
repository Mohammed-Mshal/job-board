...
export default function WhyChooseUsCard({ image, title, description }: WhyChooseUsCardProps) {
  return (
    <div className="flex flex-col items-center md:items-start text-center h-[320px] md:text-start gap-4 p-8 bg-[#18181B] hover:bg-[rgba(73,68,84)] transition-all duration-300 rounded-3xl border border-[rgba(73,68,84,0.1)]">
